...
<!-- Mirrored from portotheme.com/html/wolmart/blog-masonry-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:09:04 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="page-header">
                <div class="container">
                    <h1 class="page-title mb-0">Masonr Sidebar</h1>
                </div>
            </div>
            <!-- End of Page Header -->
                ...
                <div class="container">
                    <div class="row gutter-lg">
                        <div class="main-content">
                            <div class="row grid cols-sm-2" data-grid-options="{
                                'layoutMode': 'masonry'
                            }">
                                ...
                                <article class="post post-masonry grid-item overlay-zoom entertainment lifestyle shoes others">
                                    <figure class="post-media br-sm">
                                        <a href="post-single.html">
                                ...
                                <article class="post post-masonry grid-item overlay-zoom fashion lifestyle">
                                    <figure class="post-media br-sm">
                                        <a href="post-single.html">
                            ...
                            <ul class="pagination justify-content-center pt-6">
