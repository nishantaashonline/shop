...
<!-- Mirrored from portotheme.com/html/wolmart/product-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:08:35 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="row gutter-lg">
                        <div class="main-content">
                            <div class="product product-single row">
                                    ...
                                    <div class="product-gallery row">
                                        <div class="col-12 mb-4">
                                            <figure class="product-image">
                                                <img src="assets/images/products/masonry/1-800x900.jpg"
                                                    data-zoom-image="assets/images/products/masonry/1-800x900.jpg"
                                                    alt="Sticky Pencil" width="800" height="900">
                                                <a href="#" class="product-gallery-btn product-image-full"><i
                                                        class="w-icon-zoom"></i></a>
                                            </figure>
                                        </div>
                                        <div class="col-sm-4 col-xs-5 mb-4">
                                            <figure class="product-image">
                                                <img src="assets/images/products/masonry/2-800x900.jpg"
                                                    data-zoom-image="assets/images/products/masonry/2-800x900.jpg"
                                                    alt="Sticky Pencil" width="800" height="900">
                                                <a href="#" class="product-gallery-btn product-image-full"><i
                                                        class="w-icon-zoom"></i></a>
                                            </figure>
                                        </div>
                                        <div class="col-sm-8 col-xs-7 mb-4">
                                            <figure class="product-image">
                                                <img src="assets/images/products/masonry/3-800x900.jpg"
                                                    data-zoom-image="assets/images/products/masonry/3-800x900.jpg"
                                                    alt="Sticky Pencil" width="800" height="900">
                                                <a href="#" class="product-gallery-btn product-image-full"><i
                                                        class="w-icon-zoom"></i></a>
                                            </figure>
                                        </div>
                                        <div class="col-sm-8 mb-4 col-xs-7">
                                            <figure class="product-image">
                                                <img src="assets/images/products/masonry/4-800x900.jpg"
                                                    data-zoom-image="assets/images/products/masonry/4-800x900.jpg"
                                                    alt="Sticky Pencil" width="800" height="900">
                                                <a href="#" class="product-gallery-btn product-image-full"><i
                                                        class="w-icon-zoom"></i></a>
                                            </figure>
                                        ...
                                        <div class="col-sm-4 col-xs-5 mb-4">
                                            <figure class="product-image">
                                                <img src="assets/images/products/masonry/5-800x900.jpg"
                                                    data-zoom-image="assets/images/products/masonry/5-800x900.jpg"
                                                    alt="Sticky Pencil" width="800" height="900">
                                                <a href="#" class="product-gallery-btn product-image-full"><i
                                                        class="w-icon-zoom"></i></a>
                                            </figure>
                                        ...
                                        <div class="col-sm-4 col-xs-5 mb-4">
                                            <figure class="product-image">
                                                <img src="assets/images/products/masonry/6-800x900.jpg"
                                                    data-zoom-image="assets/images/products/masonry/6-800x900.jpg"
                                                    alt="Sticky Pencil" width="800" height="900">
                                                <a href="#" class="product-gallery-btn product-image-full"><i
                                                        class="w-icon-zoom"></i></a>
                                            </figure>
                                        ...
                                        <div class="col-sm-8 col-xs-7 mb-4">
                                            <figure class="product-image">
                                                <img src="assets/images/products/masonry/7-800x900.jpg"
                                                    data-zoom-image="assets/images/products/masonry/7-800x900.jpg"
                                                    alt="Sticky Pencil" width="800" height="900">
                                                <a href="#" class="product-gallery-btn product-image-full"><i
                                                        class="w-icon-zoom"></i></a>
                                            </figure>
                                ...
                                <div class="col-md-6 mb-5 sticky-sidebar-wrapper">
                                    <div class="product-details sticky-sidebar" data-sticky-options="{'minWidth': 768}">
                                        <h1 class="product-title">Sticky Pencil</h1>
                                        <div class="product-bm-wrapper">
                                            ...
                                            <div class="product-meta">
                                                <div class="product-categories">
                                                    Category:
                                                    <span class="product-category"><a href="#">Sports</a></span>
                                                </div>
                                                <div class="product-sku">
                                                    SKU: <span>MS46891344</span>
                                                </div>
                                            </div>
                                        </div>
...
<!-- Mirrored from portotheme.com/html/wolmart/product-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:08:37 GMT -->
</html>