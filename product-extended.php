...
<!-- Mirrored from portotheme.com/html/wolmart/product-extended.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:08:26 GMT -->
<head>
    <meta charset="UTF-8">
                                        ...
                                        <div class="swiper-wrapper row cols-sm-2">
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="assets/images/products/extended/1-800x900.jpg"
                                                        data-zoom-image="assets/images/products/extended/1-800x900.jpg"
                                                        alt="White Sofa" width="800" height="900">
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="assets/images/products/extended/2-800x900.jpg"
                                                        data-zoom-image="assets/images/products/extended/2-800x900.jpg"
                                                        alt="White Sofa" width="488" height="549">
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="assets/images/products/extended/3-800x900.jpg"
                                                        data-zoom-image="assets/images/products/extended/3-800x900.jpg"
                                                        alt="White Sofa" width="800" height="900">
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="assets/images/products/extended/4-800x900.jpg"
                                                        data-zoom-image="assets/images/products/extended/4-800x900.jpg"
                                                        alt="White Sofa" width="800" height="900">
                                                </figure>
                                            </div>
                                        </div>
                                ...
                                <div class="product-details row pl-0">
                                    <div class="col-md-6">
                                        ...
                                        <div class="product-bm-wrapper">
                                            ...
                                            <div class="product-meta">
                                                <div class="product-categories">
                                                    Category:
                                                    <span class="product-category"><a href="#">Furniture</a></span>
                                                </div>
                                        ...
                                        <div class="product-price">
                                            <ins class="new-price">$730.00</ins></div>
                            ...
                            <div class="tab tab-nav-boxed tab-nav-underline product-tabs">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="product-tab-description">
                                        ...
                                        <p class="mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                            eiusmod tempor incididunt ut labore et dolore magna aliqua. Venenatis
                                            tellus in metus vulputate eu scelerisque felis. Vel pretium lectus quam id
                                            leo in vitae turpis massa. Nunc id cursus metus aliquam. Libero
                                            id faucibus nisl tincidunt eget. Aliquam id diam maecenas ultricies mi eget
                                            mauris. </p>
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <ul class="list-style-none list-type-check">
                                                    ...
                                                    <li>Ultrices eros in cursus turpis massa tincidunt ante in nibh
                                                        mauris.</li>
                                                    <li>Cras ornare arcu dui vivamus arcu felis bibendum ut tristique.
                                                    </li>
                                        ...
                                        <div class="row align-items-center mb-4">
                                            <div class="col-md-6 mb-4">
                                                <h4 class="title tab-pane-title font-weight-bold mb-2">Product Education
                                                </h4>
                                                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                    sed do
                                                    eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                                <p>Venenatis tellus in metus vulputate eu scelerisque felis. Vel pretium
                                                    lectus quam id leo in vitae turpis massa. Nunc id cursus metus
                                                    aliquam. Libero id faucibus nisl tincidunt eget.</p>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <figure>
                                                    <img src="assets/images/products/banner-1.jpg" alt="Banner"
                                                        width="455" height="230" style="background-color: #E6E6E6;"
                                                        class="w-100" />
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="banner hotspot-banner mb-4">
                                            <figure>
                                                <img src="assets/images/products/banner-2.jpg" alt="Banner" width="930"
                                                    height="450" />
                                            </figure>
                                            <div class="hotspot-product hotspot-product-1 hotspot-right">
                                                <a href="#" class="btn-hotspot btn-quickview"><i
                                                        class="fas fa-circle"></i></a>
                                                <div class="product text-center">
                                                    <figure class="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/products/extended/1.jpg"
                                                                alt="Product" width="180" height="203" />
                                                        </a>
                                                        <div class="product-action-vertical">
                                                            <a href="#" class="btn-product-icon btn-cart"
                                                                title="Add To Cart">
                                                                <i class="w-icon-cart"></i></a>
                                                        </div>
                                                    </figure>
                                            ...
                                            <div class="hotspot-product hotspot-product-2 hotspot-top">
                                                ...
                                                <div class="product text-center">
                                                    <figure class="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/products/extended/2.jpg"
                                                                alt="Product" width="180" height="203" />
                                                        </a>
                                                        <div class="product-action-vertical">
                                                            <a href="#" class="btn-product-icon btn-cart"
                                            ...
                                            <div class="hotspot-product hotspot-product-3 hotspot-left">
                                                ...
                                                <div class="product text-center">
                                                    <figure class="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/products/extended/3.jpg"
                                                                alt="Product" width="180" height="203" />
                                                        </a>
                                                        <div class="product-action-vertical">
                                                            <a href="#" class="btn-product-icon btn-cart"
...
<!-- Mirrored from portotheme.com/html/wolmart/product-extended.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:08:30 GMT -->
</html>