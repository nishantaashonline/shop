...
<!-- Mirrored from portotheme.com/html/wolmart/product-sticky-both.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:08:41 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="page-wrapper">
        ...
        <main class="main mb-10 pb-1">
            ...
            <div class="page-content sticky-both-content">
                <div class="container">
                    <div class="row product product-single mb-5">
                        <div class="col-lg-6">
                            <div class="row cols-lg-1 cols-sm-2  product-gallery">
                                <div class="product-image-wrap">
                                    <figure class="product-image mb-4">
                                        <img src="assets/images/products/sticky/9-800x900.jpg"
                                            data-zoom-image="assets/images/products/sticky/9-800x900.jpg"
                                            alt="Super Pixel Camera" width="800" height="900">
                                ...
                                <div class="product-image-wrap">
                                    <figure class="product-image mb-4">
                                        <img src="assets/images/products/sticky/10-800x900.jpg"
                                            data-zoom-image="assets/images/products/sticky/10-800x900.jpg"
                                            alt="Super Pixel Camera" width="800" height="900">
                                        <a href="#" class="product-gallery-btn product-image-full"><i
                                                class="w-icon-zoom"></i></a>
                                    </figure>
                                ...
                                <div class="product-image-wrap">
                                    <figure class="product-image mb-4">
                                        <img src="assets/images/products/sticky/11-800x900.jpg"
                                            data-zoom-image="assets/images/products/sticky/11-800x900.jpg"
                                            alt="Super Pixel Camera" width="800" height="900">
                                        <a href="#" class="product-gallery-btn product-image-full"><i
                                                class="w-icon-zoom"></i></a>
                                    </figure>
                                ...
                                <div class="product-image-wrap">
                                    <figure class="product-image mb-4">
                                        <img src="assets/images/products/sticky/12-800x900.jpg"
                                            data-zoom-image="assets/images/products/sticky/12-800x900.jpg"
                                            alt="Super Pixel Camera" width="800" height="900">
                                        <a href="#" class="product-gallery-btn product-image-full"><i
                                                class="w-icon-zoom"></i></a>
                                    </figure>
                        ...
                        <div class="col-md-6 col-lg-3 product-details-1 sticky-sidebar-wrapper">
                            <div class="product-details sticky-sidebar" data-sticky-options="{'minWidth': 767}">
                                <h1 class="product-title">Super Pixel Camera</h1>
                                <div class="product-bm-wrapper">
                                    <figure class="brand">
                                        <img src="assets/images/products/brand/brand-3.jpg" alt="Brand" width="110"
                                            height="48" />
                                    </figure>
                                ...
                                <div class="product-price"><ins class="new-price">$420.00 - $700.00</ins></div>
                        ...
                        <div class="col-md-6 col-lg-3 product-defaults-2 sticky-sidebar-wrapper">
                            <div class="sticky-sidebar">
                                ...
                                <div class="social-links-wrapper">
                                    ...
                                    <div class="product-link-wrapper d-flex mr-0">
                                        <a href="#" class="btn-product-icon btn-wishlist w-icon-heart"><span></span></a>
                                        <a href="#"
                                            class="btn-product-icon btn-compare btn-icon-left mr-0 w-icon-compare"><span></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab tab-nav-boxed tab-nav-underline product-tabs">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="product-tab-vendor">
                                    ...
                                    <div class="col-md-6 pl-2 pl-md-6 mb-4">
                                        ...
                                        <ul class="vendor-info list-style-none">
                                            ...
                                            <li class="store-address">
                                                <label>Address:</label>
                                                <span class="detail">Steven Street, El Carjon, CA 92020, United States
                                                    (US)</span>
                                            </li>
                                ...
                                <p class="mb-2"><strong class="text-dark">A</strong> arcu cursus vitae congue mauris.
                                    Sagittis id consectetur purus
                                    ut. Tellus rutrum tellus pellentesque eu tincidunt tortor aliquam nulla. Diam in
...
<!-- Mirrored from portotheme.com/html/wolmart/product-sticky-both.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:08:42 GMT -->
</html>