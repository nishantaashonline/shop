...
<!-- Mirrored from portotheme.com/html/wolmart/become-a-vendor.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:09:09 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="container mt-0 mt-lg-10 mb-2 mb-lg-9">
                        <div class="row">
                            <div class="col-lg-4 mb-4 mb-lg-0">
                                ...
                                <a href="vendor-dokan-store.php" class="btn btn-dark btn-link btn-underline btn-icon-right">
