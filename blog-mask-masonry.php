...
<!-- Mirrored from portotheme.com/html/wolmart/blog-mask-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:09:04 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="row grid cols-lg-3 cols-md-2 mb-2" data-grid-options="{
                            ...
                            <article class="post post-mask overlay-zoom br-sm">
                                <figure class="post-media">
                                    <a href="post-single.html">
                                        <img src="assets/images/blog/classic/1.jpg" width="900"
                                            height="530" alt="blog">
                                    </a>
                                </figure>
                        ...
                        <div class="grid-item clothes">
                            <article class="post post-mask overlay-zoom br-sm">
                                <figure class="post-media">
                                    <a href="post-single.html">
                                        <img src="assets/images/blog/classic/3.jpg" width="900"
                                            height="530" alt="blog">
                                    </a>
                                </figure>
                                <div class="post-details">
                        ...
                        <div class="grid-item fashion lifestyle">
                            <article class="post post-mask overlay-zoom br-sm">
                                <figure class="post-media">
                                    <a href="post-single.html">
                                        <img src="assets/images/blog/classic/6.jpg" width="900"
                                            height="530" alt="blog">
                                    </a>
                                </figure>
                                <div class="post-details">
