...
<!-- Mirrored from portotheme.com/html/wolmart/product-accordion.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:08:20 GMT -->
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="product product-single row mb-2">
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/accordion/2-800x900.jpg"
                                                            ...
                                                            alt="Bodycare Smooth Powder" width="488" height="549">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                ...
                                <div class="col-md-6 mb-6 mb-md-8">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h1 class="product-title">Bodycare Smooth Powder</h1>
                                        <div class="product-bm-wrapper">
                                            ...
                                            <div class="product-meta">
                                                <div class="product-categories">
                                                    Category:
                                                    <span class="product-category"><a href="#">Beauty</a></span>
                                                </div>
                                    ...
                                    <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                        <div class="swiper-slide product">
                                            ...
                                            <div class="product-details">
                                                <div class="product-cat"><a href="shop-banner-sidebar.php">Accessories</a>
                                                </div>
                                                <h4 class="product-name"><a href="product-default.php">Sticky Pencil</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                        ...
                                        <div class="swiper-slide product">
                                            ...
                                            <div class="product-details">
                                                <div class="product-cat"><a href="shop-banner-sidebar.php">Electronics</a>
                                                </div>
                                                <h4 class="product-name"><a href="product-default.php">Mini
                                        ...
                                        <div class="swiper-slide product">
                                            ...
                                            <div class="product-details">
                                                <div class="product-cat"><a href="shop-banner-sidebar.php">Sports</a></div>
                                                <h4 class="product-name"><a href="product-default.php">Skate Pan</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                                        <span class="tooltiptext tooltip-top"></span>
                                        ...
                                        <div class="swiper-slide product">
                                            ...
                                            <div class="product-details">
                                                ...
                                                <h4 class="product-name"><a href="product-default.php">Clip Attachment</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                ...
                                <div class="swiper-container swiper-theme" data-swiper-options="{
                                    ...
                                    <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                        <div class="swiper-slide product">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="product-default.php">Drone</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                                        <span class="tooltiptext tooltip-top"></span>
                                        ...
                                        <div class="swiper-slide product">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="product-default.php">Official Camera</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                        ...
                                        <div class="swiper-slide product">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="product-default.php">Phone Charge Pad</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 80%;"></span>
                                        ...
                                        <div class="swiper-slide product">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="product-default.php">Fashionalble
                                                        Pencil</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                                    ...
                                                    <a href="product-default.php" class="rating-reviews">(9 reviews)</a>
                                                </div>
                                                <div class="product-pa-wrapper">
...
<!-- Mirrored from portotheme.com/html/wolmart/product-accordion.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jun 2022 06:08:21 GMT -->
</html>